...
class ObjectDetection(Node):
    def __init__(self):
        ...
        self.detection_checker = LPFL.StabilityDetector(consec_count=1) # 연속적으로 몇 번 감지 여부를 확인할지 설정
    ...
    def lidar_callback(self, msg):
        ...
        start_angle = 80  # 원하는 각도 범위의 시작 값 45 , 70
        end_angle = 90  # 원하는 각도 범위의 끝 값 90
